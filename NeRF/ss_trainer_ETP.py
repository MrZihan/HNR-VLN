...
class RLTrainer(BaseVLNCETrainer):
    ...
    def _train_interval(self, interval, ml_weight, sample_ratio):
        ...
        ############################################################
        #self.policy.net.module.vln_bert.embeddings.eval()

        #self.policy.net.module.vln_bert.lang_encoder.eval()

        #self.policy.net.module.vln_bert.img_embeddings.eval()
        #self.policy.net.module.vln_bert.global_encoder.eval()
        #self.policy.net.module.vln_bert.global_sap_head.eval()
       
        #self.policy.net.module.vln_bert.grid_pos_embeddings.eval()

        #self.policy.net.module.vln_bert.grid_encoder.eval()
        
        #self.policy.net.module.vln_bert.text_proj.eval()
        #self.policy.net.module.vln_bert.grid_proj.eval()
